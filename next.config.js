...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: '/api/session/:path*',  destination: `${CLOUD_URL}/api/session/:path*`  },
      { source: '/api/embed-proxy',     destination: `${CLOUD_URL}/api/embed-proxy`     },
      { source: '/api/subtitle-proxy',  destination: `${CLOUD_URL}/api/subtitle-proxy`  },
      { source: '/api/subtitles',        destination: `${CLOUD_URL}/api/subtitles`        },
