...
export default function HeroSlider({ items }: Props) {
  ...
  return (
    <div className="relative w-full overflow-hidden" style={{ height: 'clamp(260px, 45vw, 620px)' }}>
      ...
      {/* Content */}
      <div className="absolute bottom-0 right-0 left-0 p-5 md:p-8 max-w-2xl" dir="rtl">
        {/* Type + Year chips */}
        ...
        {isPremium ? (
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-400 via-yellow-500 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-bold px-5 py-2.5 rounded-xl transition-all hover:scale-105 active:scale-95 shadow-lg shadow-yellow-500/30"
          >
