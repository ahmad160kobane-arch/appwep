  ...
  if (!loggedIn) {
    return (
      <div className="min-h-screen bg-light-bg dark:bg-dark-bg flex flex-col items-center justify-center gap-4 px-4">
        <svg className="w-14 h-14 text-brand-primary/50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2z" /></svg>
        <h2 className="text-lg font-bold text-light-text dark:text-dark-text">قائمتك فارغة</h2>
        <p className="text-sm text-light-muted dark:text-dark-muted text-center">سجل الدخول لحفظ المحتوى في قائمتك</p>
  ...
  if (!items.length) {
    return (
      <div className="min-h-screen bg-light-bg dark:bg-dark-bg flex flex-col items-center justify-center gap-4 px-4">
        <svg className="w-14 h-14 text-brand-primary/50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2z" /></svg>
        <h2 className="text-lg font-bold text-light-text dark:text-dark-text">قائمتك فارغة</h2>
        <p className="text-sm text-light-muted dark:text-dark-muted">أضف أفلاماً ومسلسلات لمشاهدتها لاحقاً</p>
